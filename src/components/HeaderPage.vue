<template>
    <div>
        <header>
            <div class="hearder">
                <div class="left">
                    <span class="firstSpan">2022-11-18 阴 17℃</span>
                     <span class="line">|</span>
                    <span><i class="iconfont icon-dingwei"></i> 四川成都市</span>
                </div>
                <div class="right">
                    ...
                    <span ><img src="../assets/logo.png" alt=""> <h2 style="display:inline-block;margin-left: 5px;">何正旭</h2></span>
